...
<head>
    <meta charset="UTF-8">
    <script src="/src/js/typingEffect.js"></script>
    <script src="/src/js/Hamburger.js"></script>
    <script src="/src/js/showPassword.js"></script>
    <script src="/src/js/showNextField.js"></script>
...
<body class="min-h-[100svh] grid grid-rows-[auto_1fr_auto]">
    ...
    <nav class="mainNavBar">
        ...
        <a class="text-[#0000FF]" href="index.php" type="button">
          <img class="h-6"src="/src/img/drawing.svg" alt="The Y2K website!">     
        </a>
            ...
            >
              ...
              <li>
                <a
                  ...
                  href="http://138.197.100.219/src/signup.html"
                  >Sign Up</a
                >
              </li>
            </ul>
    ...
    <div class="grid 
      ...
      <div class="flex w-full h-fit pt-4 items-center justify-center">
        <video class="md:h-1/2 h-1/6 border rounded shadow-lg border-[#000000]" loop autoplay>
          <source src="/src/img/serial-experiments-lain-lain.webm">
        </video> 
      </div>
        ...
        <form class="flex flex-col gap-2"
          ...
          <div class="flex border-b border-gray-400 pr-[2px]">
            ...
            <button type="button" onclick="showPassword()" id="togglePassword">
              <img src="/src/img/eye-password-hide-svgrepo-com.svg" alt="Hide"
                  class="h-5 hidden"
                  id="hideField">
              <img src="/src/img/eye-password-show-svgrepo-com.svg" alt="Show"
                  class="h-5"
                  id="showField">
            </button>
